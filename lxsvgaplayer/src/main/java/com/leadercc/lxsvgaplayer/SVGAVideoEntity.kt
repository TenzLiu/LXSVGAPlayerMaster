package com.leadercc.lxsvgaplayer
...
import com.leadercc.lxsvgaplayer.bitmap.SVGABitmapByteArrayDecoder
import com.leadercc.lxsvgaplayer.bitmap.SVGABitmapFileDecoder
import com.leadercc.lxsvgaplayer.entities.SVGAAudioEntity
import com.leadercc.lxsvgaplayer.entities.SVGAVideoSpriteEntity
import com.leadercc.lxsvgaplayer.proto.AudioEntity
import com.leadercc.lxsvgaplayer.proto.MovieEntity
import com.leadercc.lxsvgaplayer.proto.MovieParams
import com.leadercc.lxsvgaplayer.utils.SVGARect
import com.leadercc.lxsvgaplayer.utils.log.LogUtils
...
class SVGAVideoEntity {
    ...
    private fun generateAudioMap(entity: MovieEntity): HashMap<String, ByteArray> {
        ...
        entity.images?.entries?.forEach {
            ...
            //这个有可能为空
            if(imageKey.isEmpty()){
                imageKey =  entity.audios.first().audioKey
            }
